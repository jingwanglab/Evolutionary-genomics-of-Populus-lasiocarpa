...
temp=${file##*/}
LG=${temp%%_*}
echo "$pixy --stats dxy --vcf $file  --window_size 100000 --n_cores 5  --populations $pair.txt  --output_folder $outdir_pixy  --bypass_invariant_check yes   --output_prefix $LG.pai.out &"
done
