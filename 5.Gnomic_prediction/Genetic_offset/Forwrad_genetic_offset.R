...
#shp <- shapefile("/usr_storage2/syp/LZQ/Cand2w/GF/shp/PL/New_Shapefile.shp")
...
model=a[7]
SSP=a[8]
out_index=paste(offset_outdir,"/",model,"/",model,"_",SSP,"_14K-PL_forward_offset",sep="")
...
colnames(popDatGF)=c("x","y","bio1","bio2","bio3","bio4","bio5","bio6","bio7","bio8","bio10","bio12","bio14","bio15","bio16","bio17","bio18","bio19")
for (i in 1:nrow(popDatGF)){
  onePopGF <- popDatGF[i,]
  print(i)
  #get destination populations and add gf distance
  combinedDatGF <- futClimDatGF[,c("x","y")]
  combinedDatGF["gfOffset"] <- c(rdist(onePopGF[,c("bio1","bio2","bio3","bio4","bio5","bio6","bio7","bio8","bio10","bio12","bio14","bio15","bio16","bio17","bio18","bio19")], futClimDatGF[,c("bio1","bio2","bio3","bio4","bio5","bio6","bio7","bio8","bio10","bio12","bio14","bio15","bio16","bio17","bio18","bio19")]))
